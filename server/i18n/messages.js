...
const messages = {
  ...
  te: {
    welcome: "నమస్కారం! కిసాన్ వాయిస్ హెల్ప్‌లైన్‌కు స్వాగతం. హిందీకి 1, తమిళానికి 2, ఇంగ్లీష్‌కు 3, తెలుగు కోసం 4, కన్నడ కోసం 5 నొక్కండి.",
    recordingConsentPrompt: "ఈ కాల్ రికార్డ్ చేయబడవచ్చు. సమ్మతి కోసం 1 నొక్కండి.",
    mobilePrompt: "దయచేసి మీ 10 అంకెల మొబైల్ నంబర్‌ను నమోదు చేయండి.",
    namePrompt: "మీ పేరు ఏమిటి?",
    locationPrompt: "మీ గ్రామం లేదా మండీ ఏది?",
    cropPrompt: "మీరు ఏ పంటను అమ్మాలనుకుంటున్నారు?",
    quantityPrompt: "మీ వద్ద ఎంత పరిమాణం ఉంది (కిలోలలో)?",
    pricePrompt: "కిలోకు ఎంత ధర ఆశిస్తున్నారు?",
    confirmationPrompt: "ధృవీకరించండి: {location} నుండి {quantity} {unit} {crop}, ధర ₹{price}/కిలో. మార్కెట్లో నమోదు చేయడానికి 1 నొక్కండి, రద్దు చేయడానికి 2 నొక్కండి.",
    saveSuccess: "అభినందనలు! మీ పంట డిజిటల్ మార్కెట్లో విజయవంతంగా లిస్ట్ చేయబడింది.",
    mandiBhavPrompt: "నేటి మండి ధరలు: {rates}. మెనూ కోసం 9 నొక్కండి.",
    genericError: "క్షమించండి, అర్థం కాలేదు. దయచేసి మళ్ళీ చెప్పండి."
  },

  kn: {
    welcome: "ನಮಸ್ಕಾರ! ಕಿಸಾನ್ ವಾಯ್ಸ್ ಹೆಲ್ಪ್‌ಲೈನ್‌ಗೆ ಸುಸ್ವಾಗತ. ಹಿಂದಿಗೆ 1, ತಮಿಳಿಗೆ 2, ಇಂಗ್ಲಿಷ್‌ಗೆ 3, ತೆಲುಗಿಗೆ 4, ಕನ್ನಡಕ್ಕಾಗಿ 5 ಒತ್ತಿ.",
    recordingConsentPrompt: "ಈ ಕರೆಯನ್ನು ರೆಕಾರ್ಡ್ ಮಾಡಬಹುದು. ಒಪ್ಪಿಗೆಗಾಗಿ 1 ಒತ್ತಿ.",
    mobilePrompt: "ದಯವಿಟ್ಟು ನಿಮ್ಮ 10 ಅಂಕಿಗಳ ಮೊಬೈಲ್ ಸಂಖ್ಯೆಯನ್ನು ನಮೂದಿಸಿ.",
    namePrompt: "ನಿಮ್ಮ ಹೆಸರೇನು?",
    locationPrompt: "ನಿಮ್ಮ ಊರು ಅಥವಾ ಮಂಡಿ ಯಾವುದು?",
    cropPrompt: "ನೀವು ಯಾವ ಬೆಳೆ ಮಾರಾಟ ಮಾಡಲು ಬಯಸುತ್ತೀರಿ?",
    quantityPrompt: "ನಿಮ್ಮ ಬಳಿ ಎಷ್ಟು ಪ್ರಮಾಣವಿದೆ (ಕೆಜಿಗಳಲ್ಲಿ)?",
    pricePrompt: "ಪ್ರತಿ ಕೆಜಿಗೆ ಎಷ್ಟು ಬೆಲೆ ನಿರೀಕ್ಷಿಸುತ್ತೀರಿ?",
    confirmationPrompt: "ದೃಢೀಕರಿಸಿ: {location} ದಿಂದ {quantity} {unit} {crop}, ಬೆಲೆ ₹{price}/ಕೆಜಿ. ಮಾರುಕಟ್ಟೆಯಲ್ಲಿ ನೋಂದಾಯಿಸಲು 1 ಒತ್ತಿ, ರದ್ದುಗೊಳಿಸಲು 2 ಒತ್ತಿ.",
    saveSuccess: "ಅಭಿನಂದನೆಗಳು! ನಿಮ್ಮ ಬೆಳೆ ಡಿಜಿಟಲ್ ಮಾರುಕಟ್ಟೆಯಲ್ಲಿ ಯಶಸ್ವಿಯಾಗಿ ಪಟ್ಟಿಯಾಗಿದೆ.",
    mandiBhavPrompt: "ಇಂದಿನ ಮಂಡಿ ದರಗಳು: {rates}. ಮುಖ್ಯ ಮೆನುಗಾಗಿ 9 ಒತ್ತಿ.",
    genericError: "ಕ್ಷಮಿಸಿ, ಅರ್ಥವಾಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ಮತ್ತೊಮ್ಮೆ ಹೇಳಿ."
  }
};
